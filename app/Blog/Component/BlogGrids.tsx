  ...
  return (
    <section className="bg-[#fff] px-4 pb-[70px] pt-[56px] sm:px-6 sm:pb-[90px] sm:pt-[70px] md:px-8 md:pb-[110px] md:pt-[86px] lg:px-10 lg:pb-[140px] lg:pt-[110px] xl:px-[42px] xl:pb-[180px] xl:pt-[124px] 2xl:px-[48px]">
      <div className="mx-auto max-w-[780px] text-center">
        <h1 className="mb-[22px] font-bricolage text-[38px] font-[600] leading-[0.95] tracking-[-0.06em] text-[#111111] min-[480px]:text-[44px] sm:mb-[28px] sm:text-[52px] md:text-[61px] lg:mb-[34px] lg:text-[72px] xl:mb-[40px] xl:text-[80px]">
          Our Blogs
        </h1>

        <p className="mx-auto max-w-[590px] pb-[34px] font-inter text-[13px] font-[500] leading-[1.45] tracking-[-0.01em] text-[#6D6D6D] min-[480px]:text-[14px] sm:pb-[42px] sm:text-[15px] md:pb-[48px] md:text-[16px] xl:pb-[52px] xl:text-[16px]">
