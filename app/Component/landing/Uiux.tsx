...
export default function Uiux({
  ...
  return (
    <section
      id={sectionId ?? slug}
      className={`relative bg-[#F7F7F7] py-[72px] sm:py-[92px] lg:py-[112px] ${className}`}
    >
      <div className="mx-auto w-full max-w-[1120px] px-5 sm:px-6 lg:px-8 xl:px-0">
        <div className="mb-[34px] flex flex-col gap-7 sm:mb-[42px] sm:flex-row sm:items-start sm:justify-between lg:mb-[52px]">
          <div className="max-w-[565px]">
            <h2 className="font-bricolage text-[34px] font-semibold leading-[0.98] tracking-[-0.065em] text-black max-[768px]:text-[44px] lg:text-[50px]">
              {service.detailPage.heroTitle}
            </h2>

            <p className="mt-5 max-w-[520px] font-inter text-[13px] font-medium leading-[1.45] tracking-[-0.025em] text-black/50 sm:text-[14px] lg:text-[15px]">
