  ...
  return (
    <section className="bg-white py-24 text-center sm:py-36">
      <div className="mx-auto max-w-[760px] px-5">
        ...
        <p className="mx-auto mt-5 max-w-[430px] text-[13px] leading-[1.8] text-black/50 sm:text-[15px]">
          From brand identity to website experience, we design systems that look
          premium and remain consistent everywhere.
        </p>
