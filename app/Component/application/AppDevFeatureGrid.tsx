...
function AppDevMockVisual({ type }: { type: string }) {
  if (type === "website") {
    return (
        ...
        <div className="mb-10 flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-4 max-w-[560px] text-[13px] leading-[1.8] text-black/50 sm:text-[15px]">
              We build complete applications with frontend interfaces, backend
              APIs, database architecture, authentication, role-based access and
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {cards.map((card) => (
            ...
            >
              ...
              <AppDevMockVisual type={card.type} />
            </article>
          ))}
        </div>
      </div>
