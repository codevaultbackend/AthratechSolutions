const steps = [
  {
    title: "Discovery",
    text: "We understand users, goals, features and app journey.",
  },
  {
    title: "Wireframe",
    text: "We plan screen structure and user flow before visual design.",
  },
  {
    title: "UI Design",
    text: "We create clean, consistent and production-ready mobile screens.",
  },
  {
    title: "Prototype",
    text: "We connect screens into a smooth clickable experience.",
  },
];
      ...
      <div className="mx-auto max-w-[1120px] px-5 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-[0.9fr_1.1fr]">
          ...
          <p className="max-w-[500px] text-[13px] leading-[1.8] text-black/50 sm:text-[15px]">
            We follow a complete app design process from strategy to final UI,
            keeping every screen clean, usable and consistent.
          </p>
        </div>
