    ...
    <main className=" w-full overflow-hidden bg-white">
      <div className="max-w-[1071px] mx-auto">
        <Hero
          heroDescription={
            <>
              A <span className="font-[600]">role-based</span> inventory platform built for modern
              businesses, managing procurement, stock, sales, and accounts across teams
              with real-time visibility, structured access control, and complete
